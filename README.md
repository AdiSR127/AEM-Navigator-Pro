...
A Chrome Extension built for Adobe Experience Manager developers, technical consultants, and solution architects. AEM Navigator Pro puts every console, diagnostic tool, and page-level JCR insight one click away — without ever leaving your current page.

🔗 **[Install from the Chrome Web Store](https://chromewebstore.google.com/detail/aem-navigator-pro/bihcgeikkjojoelebclkoflhkipdihnb?hl=en)**
...
Install directly from the [Chrome Web Store listing](https://chromewebstore.google.com/detail/aem-navigator-pro/bihcgeikkjojoelebclkoflhkipdihnb?hl=en) — no setup required.
...
**Aditya Singh** — [LinkedIn](https://www.linkedin.com/in/aditya-s-b29ab0120/)

---

## Privacy Policy

This extension, "AEM Navigator Pro," does not collect, store, or transmit any user data to any external server. All JCR metadata (e.g., Node Type, User, Status) is fetched locally from the user's authenticated AEM session and displayed only within the extension's interface. Users are advised to review the privacy policies of their respective Adobe Experience Manager instances.
